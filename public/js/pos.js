...
$(document).ready(function() {
    ...
    $('button#pos-finalize').click(function() {
        ...
        // Validate shipping status for repair invoices - must be "delivered"
        var sub_type = $('input[name="sub_type"]').val();
        if (sub_type === 'repair') {
            var shipping_status = $('#shipping_status').val();
            if (!shipping_status || shipping_status !== 'delivered') {
                var error_msg = typeof repair_shipping_must_be_delivered !== 'undefined' 
                    ? repair_shipping_must_be_delivered 
                    : 'Shipping status must be "Delivered" before creating a repair invoice. Please update the shipping status first.';
    ...
    $('button.pos-express-finalize').click(function() {
        ...
        //Do NOT auto-fill remaining balance; let user enter amounts manually
...
function calculate_billing_details(price_total) {
    ...
    // Do not auto-fill the first payment row; let the user enter amounts
