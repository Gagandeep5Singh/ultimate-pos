    ...
    $(document).on('click', '.btn-modal', function(e) {
        ...
        $.ajax({
            ...
            error: function(xhr, status, error) {
                ...
                var errorMsg = '<div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal">&times;</button><h3>Error</h3></div><div class="modal-body"><div class="alert alert-danger">Failed to load content. Please try again.</div></div><div class="modal-footer"><button type="button" class="btn btn-default" data-dismiss="modal">Close</button></div></div></div>';
                $(container).html(errorMsg).modal('show');
            }
        });
    });
