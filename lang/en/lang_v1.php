...
return [
    ...
    'enable_lot_number' => 'Enable IMEI',
    'tooltip_enable_lot_number' => 'This will enable you to enter IMEI for each purchase line in purchase screen',
    'lot_number' => 'IMEI',
    ...
    'quantity_error_msg_in_lot' => 'Only :qty :unit available in the selected IMEI',
    'show_product_expiry' => 'Show product expiry',
    'show_lot_number' => 'Show IMEI',
    'expiry' => 'Expiry',
    'lot' => 'IMEI',
    'lot_n_expiry' => 'IMEI & Expiry',
    ...
    'lot_numbers_are_used_in_sale' => 'Cannot be deleted, Some IMEIs from this purchase are already sold',
    ...
    'total_bank_transfer' => 'Total bank TF',
    ...
    'lot_number_instructions' => 'Only if IMEI is enabled. You can enable IMEI from <br><code>Business Settings > Purchases > Enable IMEI</code>',
    ...
    'import_export_product_details' => 'Import Export Product Details',
    'export_product_details_template' => 'Export Product Details Template',
    'details_import_instruction_1' => 'Export product details template by clicking on above button',
    'details_import_instruction_2' => 'Make changes in product name, brand, category, and subcategory.',
    'details_import_instruction_3' => 'Do not change SKU column - it is used to identify products',
    'details_import_instruction_4' => 'After making changes import the file',
    'product_details_imported_successfully' => 'Product details imported successfully',
    ...
    'key_invoice_no' => 'Key Invoice No.',
    'with_nif' => 'With NIF',
    'not' => 'Not',
    'please_select_with_nif_first' => 'Please Select With Nif First',
    'please_select' => 'Please Select',
    'nif_required_for_multiple_payments' => 'NIF is required for multiple payments',
    'key_invoice_no_required' => 'Key Invoice No. is required',
    'key_invoice_no_filter' => 'Key Invoice No.',
    'without_nif' => 'Without NIF',
    'please_select_with_nif_first' => 'Please select With NIF option first',
    'with_nif_selection_required' => 'You must select With NIF to proceed',
    'update_key_invoice_no' => 'Update Key Invoice No.',
];
