...
@section('content')
    ...
    <section class="content no-print">
        @component('components.filters', ['title' => __('report.filters')])
            ...
            <div class="col-md-3">
                <div class="form-group">
                    {!! Form::label('key_invoice_no_filter', __('lang_v1.key_invoice_no_filter') . ':') !!}
                    {!! Form::select('key_invoice_no_filter', [
                        '' => __('lang_v1.all'),
                        'with_nif' => __('lang_v1.with_nif'),
                        'without_nif' => __('lang_v1.without_nif')
                    ], null, [
                        'class' => 'form-control select2',
                        'style' => 'width:100%',
                        'id' => 'key_invoice_no_filter',
                    ]) !!}
                </div>
            </div>
        @endcomponent
                ...
                <table class="table table-bordered table-striped ajax_view" id="sell_table">
                    <thead>
                        <tr>
                            ...
                            <th>@lang('lang_v1.key_invoice_no')</th>
...
@section('javascript')
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            sell_table = $('#sell_table').DataTable({
                ...
                "ajax": {
                    ...
                    "data": function(d) {
                        ...
                        if ($('#key_invoice_no_filter').length) {
                            d.key_invoice_no_filter = $('#key_invoice_no_filter').val();
                        }
            ...
            $(document).on('change',
                '#sell_list_filter_location_id, #sell_list_filter_customer_id, #sell_list_filter_payment_status, #created_by, #sales_cmsn_agnt, #service_staffs, #shipping_status, #sell_list_filter_source, #payment_method, #key_invoice_no_filter',
                function() {
                    sell_table.ajax.reload();
                });
