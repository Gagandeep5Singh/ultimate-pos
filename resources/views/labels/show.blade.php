				...
				<table class="table table-bordered">
					<tr>
						...
						<td>
							<div class="checkbox">
							    <label>
							    	<input type="checkbox" name="print[price]" value="0" id="is_show_price"> <b>@lang( 'barcode.print_price' )</b>
							    </label>
							</div>
					...
					<tr>
						...
						<td>
							@if(request()->session()->get('business.enable_lot_number') == 1)
								...
								<div class="checkbox">
								    <label>
								    	<input type="checkbox" name="print[lot_number]" value="0"> <b>@lang( 'lang_v1.print_lot_number' )</b>
								    </label>
								</div>
						...
						<td>
							@if(request()->session()->get('business.enable_product_expiry') == 1)
								<div class="checkbox">
								    <label>
								    	<input type="checkbox" checked name="print[exp_date]" value="0"> <b>@lang( 'lang_v1.print_exp_date' )</b>
								    </label>
								</div>
