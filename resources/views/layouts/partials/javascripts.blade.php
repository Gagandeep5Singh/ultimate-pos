...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        if ($('#calendar').length && typeof $.fn.fullCalendar !== 'undefined') {
        ...
        // Optimize popover handler - use single delegated handler
        $(document).on('click', function (e) {
            // Only initialize popovers if they exist
            ...
            if (!$(e.target).closest('[data-toggle="popover"]').length && !$(e.target).closest('.popover').length) {
                $('[data-toggle="popover"]').each(function () {
                    if ($(this).data('bs.popover') && $(this).data('bs.popover').tip && $(this).data('bs.popover').tip.hasClass('in')) {
                        $(this).popover('hide');
                    }
                });
            }
        ...
        // Defer non-critical button class removal to reduce initial blocking
        setTimeout(function() {
