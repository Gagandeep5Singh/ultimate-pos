...
<div class="row invoice-info">
	...
	<div class="col-md-6 invoice-col width-50">
		...
		@if(!empty($receipt_details->change_return))
			<div class="text-right font-23">
				<span class="pull-left">@lang('lang_v1.change_return'):</span>
				{{$receipt_details->change_return['amount']}}
			</div>
		@endif
	...
	<div class="col-md-6 invoice-col width-50 ">
		...
		@if(!empty($receipt_details->logo))
			<div style="margin-bottom: 20px; padding: 20px 0;">
				<img style="max-height: 200px; width: auto; display: block; margin: 0 auto;" src="{{$receipt_details->logo}}" class="img center-block">
			</div>
...
<div class="row  mt-5">
	<div class="col-xs-12">
		<table class="table table-no-top-cell-border table-slim mb-12" style="border-collapse: collapse; border: 2px dashed #000;">
			<thead>
				...
				@foreach($receipt_details->lines as $line)
					<tr>
						...
						<td>
                            ...
                            @if(!empty($line['battery_percentage'])) | Battery: {{$line['battery_percentage']}} @endif
...
<div class="col-md-12">
    @if(empty($receipt_details->hide_price) && !empty($receipt_details->tax_summary_label) )
        ...
        @if(!empty($receipt_details->taxes))
        	<table class="table table-slim" style="border-collapse: collapse;">
        		<tr style="border-bottom: 2px dashed #000;">
        			<th colspan="2" class="text-center" style="padding: 12px; border-bottom: 2px dashed #000; font-weight: bold;">{{$receipt_details->tax_summary_label}}</th>
        		</tr>
