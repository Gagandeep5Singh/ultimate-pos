        ...
        <div class="ticket">
			@if(empty($receipt_details->letter_head))
				@if(!empty($receipt_details->logo))
					<div class="text-box centered" style="margin-bottom: 20px; padding: 20px 0;">
						<img style="max-height: 200px; width: auto; display: block; margin: 0 auto;" src="{{$receipt_details->logo}}" alt="Logo">
					</div>
					<!-- Double dashed separator after logo -->
					<div style="margin: 20px 0; padding: 15px 0; text-align: center;">
			...
			@if(!empty($receipt_details->change_return))
				<div class="flex-box">
					<p class="width-50 text-left">@lang('lang_v1.change_return'):</p>
					<p class="width-50 text-right">{{$receipt_details->change_return['amount']}}</p>
				</div>
			@endif
