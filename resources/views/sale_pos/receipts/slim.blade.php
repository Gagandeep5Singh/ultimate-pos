        ...
        <div class="ticket">
        	@if(empty($receipt_details->letter_head))
				@if(!empty($receipt_details->logo))
					<div class="text-box centered" style="margin-bottom: 15px;">
						<img style="max-height: 200px; width: auto;" src="{{$receipt_details->logo}}" alt="Logo">
					</div>
				@endif
				<div class="text-box">
				<!-- Logo -->
			...
			@if(empty($receipt_details->hide_price))
				...
				@if(!empty($receipt_details->change_return))
					<div class="flex-box">
						<p class="width-50 text-right">@lang('lang_v1.change_return'):</p>
