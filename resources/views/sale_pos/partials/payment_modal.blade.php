            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="row" id="nif_section">
                            <div class="col-md-6">
                                <div class="form-group">
                                    {!! Form::label('with_nif', __('lang_v1.with_nif') . ':*') !!}
                                    @php
                                        $with_nif_default = '';
                                        $key_invoice_no_display = 'none';
                                        if (!empty($transaction)) {
                                            if (!empty($transaction->key_invoice_no)) {
                                                $with_nif_default = '1';
                                                $key_invoice_no_display = 'block';
                                            } else {
                                                $with_nif_default = '0';
                                            }
                                        }
                                    @endphp
                                    {!! Form::select('with_nif', ['' => __('lang_v1.please_select'), '0' => __('lang_v1.not'), '1' => __('lang_v1.with_nif')], $with_nif_default, [
                                        'class' => 'form-control select2',
                                        'id' => 'with_nif',
                                        'style' => 'width:100%',
                                        'required' => true,
                                    ]) !!}
                                    <span class="help-block text-danger" id="with_nif_error" style="display: none;"></span>
                                </div>
                            </div>
                            <div class="col-md-6" id="key_invoice_no_wrapper" style="display: {{ $key_invoice_no_display }};">
                                <div class="form-group">
                                    {!! Form::label('key_invoice_no', __('lang_v1.key_invoice_no') . ':*') !!}
                                    {!! Form::text('key_invoice_no', !empty($transaction) ? $transaction->key_invoice_no : null, [
                                        'class' => 'form-control',
                                        'id' => 'key_invoice_no',
