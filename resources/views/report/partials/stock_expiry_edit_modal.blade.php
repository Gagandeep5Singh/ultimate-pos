<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <div class="modal-body">
      ...
      <div class="col-md-6">
        <div class="form-group">
          {!! Form::label('battery_percentage', 'Battery %:') !!}
          {!! Form::number('battery_percentage', $purchase_line->battery_percentage, ['class' => 'form-control', 'min' => '0', 'max' => '100', 'step' => '0.01', 'placeholder' => 'Battery %']); !!}
        </div>
      </div>
      </div>
    </div>
