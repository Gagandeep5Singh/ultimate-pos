    ...
    <div class="row">
        <div class="col-md-12">
            @component('components.filters', ['title' => __('report.filters')])
              {!! Form::open(['url' => action([\App\Http\Controllers\ReportController::class, 'getLotReport']), 'method' => 'get', 'id' => 'lot_report_filter_form' ]) !!}
                <div class="col-md-3">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        {!! Form::label('stock_status', __('lang_v1.stock_status') . ':') !!}
                        {!! Form::select('stock_status', ['' => __('messages.all'), 'in_stock' => __('lang_v1.have_stock'), 'out_of_stock' => __('lang_v1.out_of_stock')], null, ['class' => 'form-control select2', 'style' => 'width:100%']); !!}
                    </div>
                </div>
