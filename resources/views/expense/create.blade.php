	...
	<div class="box box-solid">
		<div class="box-body">
			<div class="row">
				...
				@else
					@php 
						$default_location_id = !empty($default_location) ? $default_location->id : null; 
					@endphp
				@endif
				<div class="col-sm-4">
					<div class="form-group">
						{!! Form::label('location_id', __('purchase.business_location').':*') !!}
						{!! Form::select('location_id', $business_locations, $default_location_id, ['class' => 'form-control select2', 'placeholder' => __('messages.please_select'), 'required'], $bl_attributes); !!}
					</div>
				</div>
