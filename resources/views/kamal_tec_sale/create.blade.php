                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            {!! Form::select('kamal_tec_customer_id', $kamal_tec_customers, old('kamal_tec_customer_id'), ['class' => 'form-control select2', 'placeholder' => __('messages.please_select'), 'id' => 'kamal_tec_customer_id', 'required', 'style' => 'width:100%']); !!}
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        {!! Form::text('floa_ref', old('floa_ref'), ['class' => 'form-control', 'placeholder' => 'Enter installment reference']); !!}
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#kamal_tec_customer_id').select2({
            ...
            allowClear: true,
            ajax: {
                url: '{{ route('kamal-tec-customers.get-customers') }}',
                dataType: 'json',
                delay: 250,
        ...
        // If customer was just created, select it
        @if(session('selected_customer_id'))
            var customerId = {{ session('selected_customer_id') }};
        ...
        $('#create_new_customer_btn').on('click', function() {
            window.location.href = '{{ action([\App\Http\Controllers\KamalTecCustomerController::class, 'create']) }}?return_to=sale';
        });
        ...
        $('#add_sale_form').validate({
            ...
            messages: {
                kamal_tec_customer_id: {
                    required: "Please select a Kamal Tec customer"
                },
                sale_date: {
