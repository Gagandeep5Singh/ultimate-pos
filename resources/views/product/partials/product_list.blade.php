@php 
    ...
    $permitted_loc_ids = auth()->user()->permitted_locations($business_id);
    if ($permitted_loc_ids === 'all') {
        $location_list = \App\BusinessLocation::where('business_id', $business_id)->get();
    } else {
        $location_list = \App\BusinessLocation::whereIn('id', (array)$permitted_loc_ids)->get();
    }
@endphp
    ...
    <thead>
        <tr>
            ...
            @can('access_default_selling_price')
                @php $colspan += 5; @endphp {{-- selling + sale + discount + 3x + profit after klarna --}}
