...
<td>
    <div class="input-group">
        ...
        {!! Form::text(
            'products[' . $product->id . '][variations][' . $variation->id . '][default_purchase_price]',
            @num_format($variation->default_purchase_price),
            [
                'placeholder' => __('product.exc_of_tax'),
                'class' => 'form-control input-sm input_number pp_exc_tax'
            ]
        ); !!}
    </div>
    ...
    <div class="input-group">
        ...
        {!! Form::text(
            'products[' . $product->id . '][variations][' . $variation->id . '][dpp_inc_tax]',
            @num_format($variation->dpp_inc_tax),
            [
...
<td>
    {!! Form::text(
        'products[' . $product->id . '][variations][' . $variation->id . '][profit_percent]',
...
<td>
    <div class="input-group">
        ...
        {!! Form::text(
            'products[' . $product->id . '][variations][' . $variation->id . '][default_sell_price]',
    ...
    <div class="input-group">
        ...
        {!! Form::text(
            'products[' . $product->id . '][variations][' . $variation->id . '][sell_price_inc_tax]',
            @num_format($variation->sell_price_inc_tax),
            [
                'placeholder' => __('product.dpp_inc_tax'),
...
<td>
    {!! Form::text(
        'products[' . $product->id . '][variations][' . $variation->id . '][sale_price]',
        !empty($variation->sale_price) ? @num_format($variation->sale_price) : null,
