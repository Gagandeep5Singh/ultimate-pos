				...
				<tr>
					...
					@can('access_default_selling_price')
						...
						<td>
						 ...
						 <td>
                            @if(!empty($variation->sale_price) && $variation->sale_price > 0 && $variation->sale_price < $variation->sell_price_inc_tax)
                                @php
                                    $diff = $variation->sell_price_inc_tax - $variation->sale_price;
                                    $percent = $variation->sell_price_inc_tax > 0 ? round($diff / $variation->sell_price_inc_tax * 100, 2) : 0;
                                @endphp
                        ...
                        <td>
                            @if(!empty($variation->sale_price) && $variation->sale_price > 0)
                                <span class="display_currency" data-currency_symbol="true">{{ $variation->sale_price }}</span>
                            @endif
                        </td>
