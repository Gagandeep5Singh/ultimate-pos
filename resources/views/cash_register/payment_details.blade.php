  ...
  <div class="col-sm-12">
    ...
    <table class="table table-condensed">
      ...
      <tr class="success">
        ...
        <td>
          <b><span class="display_currency" data-currency_symbol="true">{{ $register_details->cash_in_hand + $register_details->total_cash }}</span></b>
        </td>
      </tr>
      <tr class="success">
        <th>
        ...
        <td>
          <b><span class="display_currency" data-currency_symbol="true">{{ $details['transaction_details']->credit_sales ?? 0 }}</span></b>
        </td>
      </tr>
      <tr class="success">
        <th>
