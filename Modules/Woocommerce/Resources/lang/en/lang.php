...
return [
    ...
    'sync_price_stock_sku' => 'Sync Price & Stock by SKU',
    'sync_price_stock_sku_help' => '<ul><li>Updates only price and stock for existing WooCommerce products.</li><li>Matches products by SKU only (works with all product types).</li><li>Does not create new products.</li><li>Please, Do not refresh or leave the page while synchronizing</li></ul>',
    'price_stock_synced' => 'Price & Stock Sync: :updated updated, :not_found not found',
    'errors_occurred' => ':count errors occurred',
];
