...
Route::get('/repair/job-sheet', [JobSheetController::class, 'index']);
...
Route::middleware('web', 'authh', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu')->prefix('repair')->group(function () {
    ...
    Route::post('/jobsheet/update-due-date', [JobSheetController::class, 'updateDueDate'])->name('jobsheet.updateDueDate');
    ...
    Route::resource('/repair', 'Modules\Repair\Http\Controllers\RepairController')
    ->except(['create', 'edit'])
    ->where(['repair' => '[0-9]+']); // ✅ This prevents "job-sheet" from being treated as an ID
    ...
    Route::get('job-sheet/{id}/get-delivery-note', 
    [Modules\Repair\Http\Controllers\JobSheetController::class, 'getDeliveryNote'])
    ->name('jobsheet.getDeliveryNote');
    ...
    Route::get('/repair/job-sheet', [\Modules\Repair\Http\Controllers\JobSheetController::class, 'index']);
    Route::get('job-sheet/{id}/summary', [JobSheetController::class, 'summary']);
