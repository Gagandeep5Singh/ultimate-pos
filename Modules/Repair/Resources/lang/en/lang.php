...
return [
    ...
    'delivery_time_extended' => 'Delivery Time Extended',
    'delivery_time_updated' => 'Delivery Time Updated',
    ...
    'delivered' => 'Delivered',
    'shipping_must_be_delivered_to_create_invoice' => 'Shipping status must be "Delivered" before creating/updating a repair invoice. Please change the shipping status to "Delivered" first.',
'pending_job_sheets_description' => 'Job sheets that are pending completion',
'completed_job_sheets_description' => 'Job sheets that are completed but not yet invoiced',
'delivered_job_sheets_description' => 'Job sheets that are completed and have been invoiced',
];
