...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    // Prompt users to pick location immediately after login
    Route::get('/select-location', [CashRegisterController::class, 'showLocationSelection'])->name('login.select_location');
    Route::post('/select-location', [CashRegisterController::class, 'storeLocationSelection'])->name('login.store_location');
    ...
    Route::get('/products/update-product-details', [ProductController::class, 'updateProductDetails'])->name('products.update_product_details');
    Route::get('/products/export-product-details', [ProductController::class, 'exportProductDetails'])->name('products.export_product_details');
    Route::post('/products/import-product-details', [ProductController::class, 'importProductDetails'])->name('products.import_product_details');
    ...
    Route::get('/reports/all-products', [ReportController::class, 'getAllProductsReport']);
    Route::get('/reports/export-all-products', [ReportController::class, 'exportAllProductsReport']);
    Route::get('/reports/update-products-csv', [ReportController::class, 'updateProductsCsvForGoogleSheets']);
    ...
    // routes/web.php
Route::get('dashboard/profit-summary', [\App\Http\Controllers\HomeController::class, 'profitSummary'])
    ->name('dashboard.profit_summary');
    ...
    Route::post('kamal-tec-sales/{id}/update-status', [\App\Http\Controllers\KamalTecSaleController::class, 'updateStatus'])->name('kamal-tec-sales.update-status');
    Route::get('kamal-tec-sales/{id}/edit-floa-ref', [\App\Http\Controllers\KamalTecSaleController::class, 'editFloaRef'])->name('kamal-tec-sales.edit-floa-ref');
    Route::post('kamal-tec-sales/{id}/update-floa-ref', [\App\Http\Controllers\KamalTecSaleController::class, 'updateFloaRef'])->name('kamal-tec-sales.update-floa-ref');
    
    // Kamal Tec Customer routes
    Route::resource('kamal-tec-customers', \App\Http\Controllers\KamalTecCustomerController::class);
    Route::get('kamal-tec-customers-ajax/get-customers', [\App\Http\Controllers\KamalTecCustomerController::class, 'getCustomers'])->name('kamal-tec-customers.get-customers');
   ...
   Route::get(
    'products/export-product-prices',
    [\App\Http\Controllers\ProductController::class, 'exportProductPricesWithStock']
)->name('products.export_product_prices'); // PLURAL 'prices' to match blade file

Route::get('/reports/klarna-details', [ReportController::class, 'getKlarnaTransactionDetails']);

Route::get('/products/export-product-prices', 'ProductController@exportProductPrices')
    ->name('products.export_product_prices');
    ...
    Route::get('sells/edit-key-invoice-no/{id}', [SellController::class, 'editKeyInvoiceNo']);
    Route::put('sells/update-key-invoice-no/{id}', [SellController::class, 'updateKeyInvoiceNo']);
...
// Public route for Google Sheets CSV access (no auth required)
Route::get('/reports/products-csv', [ReportController::class, 'serveProductsCsv']);
